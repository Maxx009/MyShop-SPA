!function() {
    ...
    function DataAccessService($http, $q) {
        function error(error) {
            deferer.reject(error), console.error("In Data-Service Error-Callback :", error);
        }
        function success(response) {
            deferer.resolve(response.data), console.info("In Data-Service Success-Callback :", response);
        }
        function get(url) {
            return deferer = $q.defer(), $http.get(url, {
                cache: !1
            }).then(success, error), deferer.promise;
        }
