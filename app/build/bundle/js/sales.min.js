!function() {
    ...
    function AddBillController($state, dataAccessService, SalesService, constants, alertMessage, messages) {
        ...
        vm.saveBill = saveBill, vm.resetBill = resetBill, vm.getCustomers = SalesService.getCustomers, 
        vm.getProducts = SalesService.getProducts, vm.alertService = alertMessage, vm.addNewRow = addNewRow, 
    ...
    function EditBillController($state, dataAccessService, SalesService, constants, alertMessage, messages, billItem) {
        ...
        vm.calculate = calculate, vm.calibrateWeights = calibrateWeights, activate();
    }
