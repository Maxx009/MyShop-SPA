angular.module('myShopApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('error-messages.html',
    "<div><span class=\"text-danger\" ng-message=\"minlength\">Minmum required data not entered</span> <span class=\"text-danger\" ng-message=\"maxlength\">Maximum allowed data exceeded.</span> <span class=\"text-danger\" ng-message=\"number\">Only number are allowed</span> <span class=\"text-danger\" ng-message=\"min\">Value too less</span> <span class=\"text-danger\" ng-message=\"max\">Value too more</span> <span class=\"text-danger\" ng-message=\"required\">This field is required.</span></div>"
  );
