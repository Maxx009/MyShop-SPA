!function() {
    ...
    angular.module("myShopApp").directive("capitalize", capitalizeDirective), capitalizeDirective.inject = [ "$parse" ];
}(), function() {
    "use strict";
    ...
    angular.module("myShopApp").directive("picker", pickerDirective), pickerDirective.inject = [ "dependency1" ];
}(), function() {
    "use strict";
    ...
    function DataAccessService($http, $q) {
        function error(error) {
            error.errorMessage = "", 11e3 === error.code && (error.errorMessage = error.errmsg.match(/{ :([^}]+)}/)[1] + " Already Exists."), 
    ...
    "use strict";
    $templateCache.put("error-messages.html", '<div><span class="text-danger" ng-message="minlength">Minmum required data not entered</span> <span class="text-danger" ng-message="maxlength">Maximum allowed data exceeded.</span> <span class="text-danger" ng-message="number">Only number are allowed</span> <span class="text-danger" ng-message="min">Value too less</span> <span class="text-danger" ng-message="max">Value too more</span> <span class="text-danger" ng-message="required">This field is required.</span></div>'), 
